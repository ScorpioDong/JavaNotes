...
public class SystemTest {
    ...
    @Test
    public void testSaveXML() throws IOException, IllegalAccessException, NoSuchMethodException {
    ...
    @Test
    public void testSaveJson() throws IOException, IllegalAccessException {
    ...
    @Test
    public void testLoadXML() throws IllegalAccessException, DocumentException, NoSuchMethodException {
        StudentManage manage = new StudentManage();
    ...
    @Test
    public void testLoadJson() throws IllegalAccessException, DocumentException {
        StudentManage manage = new StudentManage();
        DataUtil.loadFromJson(manage);
        manage.show();
    }
    ...
    public void testFilter() {
        ...
        manage.filter(stu -> (stu.getAge() >= 18 && stu.getAge() < 70));

        System.out.println("----------------------------------");

        manage.filter(stu -> (stu.getAge() >= 18 && stu.getAge() < 70) && (stu.getMathScore() > 80));
    }
